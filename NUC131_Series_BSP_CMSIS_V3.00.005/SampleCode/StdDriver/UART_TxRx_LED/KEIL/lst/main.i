        ...
        while((((((UART_T *) ((( uint32_t)0x40000000) + 0x50000)))->ISR & (1ul << 0))>>0))
        {
            ...
            if(u8InChar == '0')
            {
                g_bWait = 0;
							...
							if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((13)<<2)))))(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((13)<<2)))) = 0;
							printf("PB13 ON~\r\n");
						}else if(u8InChar == '3'){
							if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((13)<<2))))==0)(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((13)<<2)))) = 1;
							printf("PB13 OFF~\r\n");
						}
...
void UART_FunctionTest()
{
    ...
    printf("+-----------------------------------------------------------+\n");
		GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)), 0x00002000, 0x1UL);
